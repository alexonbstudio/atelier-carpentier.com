...
<!--Template-->
  ...
  <link href="<?php echo $protocols.'://'.$CDNdomainTLD.'/'.$version['internal']['combined']['css']['all']; ?>" rel="stylesheet">
 <!--  <link href="<?php echo $protocols.'://'.$CDNdomainTLD.'/'.$version['internal']['production']['css']['mamba']; ?>" rel="stylesheet">
  <link href="<?php echo $protocols.'://'.$CDNdomainTLD.'/'.$version['internal']['production']['css']['tpl']; ?>" rel="stylesheet">
  <link href="<?php echo $protocols.'://'.$CDNdomainTLD.'/'.$version['internal']['production']['css']['tplsgen']; ?>" rel="stylesheet">-->
  <!-- Google Fonts -->
    ...
    <div class="container">
      ...
      <div class="logo float-left">
       <!-- <h1 class="text-light"><a href="index.html"><span>Mamba</span></a></h1>-->
        ...
        <a href="<?php echo $protocols.'://'.$domainTLD; ?>"><img src="<?php echo $protocols.'://'.$CDNdomainTLD.'/'.$images['dir'].'/'.$images['manager']['logo']['big']; ?>" alt="<?php echo $sites['name']; ?>"></a>
      </div>

      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          <li><a href="<?php echo $protocols.'://'.$domainTLD; ?>/#contact">Chez vous en -30min<br>Devis Gratuit</a></li>
          <li><a href="<?php echo $protocols.'://'.$domainTLD; ?>/#contact">24h sur 24<br>7 jours sur 7</a></li>
          <li><a href="tel:<?php echo $business['local']['phone']['code']; ?><?php echo $business['local']['phone']['number']; ?>"><?php echo $business['local']['phone']['normal']; ?><?php echo $business['local']['phone']['longs']; ?></a></li>
          <li><a href="tel:<?php echo $business['local']['mobile']['code']; ?><?php echo $business['local']['mobile']['number']; ?>"><?php echo $business['local']['mobile']['normal']; ?><?php echo $business['local']['mobile']['longs']; ?></a></li>
        </ul>
      </nav><!-- .nav-menu -->
