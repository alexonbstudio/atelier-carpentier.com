      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-info">
            <!--<img src="<?php echo $protocols.'://'.$domainTLD.'/'.$images['dir'].'/'.$images['manager']['home']['certifier']['10-ans']; ?>" class="img-fluid">--><i class="tplsgen tplsgen-10ans-d_cennale img-fluid"></i>
          </div>
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Information</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="<?php echo $protocols.'://'.$domainTLD.'/'.$law['legal']['url']['default']; ?>"><?php echo $law['legal']['title']; ?></a></li>
            </ul>
          </div>
          <div class="col-lg-6 col-md-6 footer-links">
            <h4>Nos agences</h4>
            <ul>
              <li> <?php echo $business['local']['address'].' '.$business['local']['postal'].' '.$business['local']['city']; ?></li>
              <li> 136 rue Jean Jaurès 94700 Maisons-Alfort</li>
            </ul>
          </div>
  ...
  <footer class="py-5 bg-dark">
    <div class="container">
      <p class="m-0 text-center text-white"><?php echo $sites['copyright']['frontend'].' <a href="'.$protocols.'://'.$domainTLD.'">'.$sites['name'].'</a> .'.$law['full']['content']['footer']; ?> | Propulsé par <a href="https://webjet.cloud">www.WebJet.Cloud</a> Open-Source PHP
	  </p>
...
<!--Template-->
  ...
  <script src="<?php echo $protocols.'://'.$CDNdomainTLD.'/'.$version['internal']['production']['js']['mamba']; ?>"></script>
